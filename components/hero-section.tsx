...
useEffect(() => {
  ...
  <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
    ...
    {/* TEXT CONTENT */}
    <div className="space-y-6 max-w-4xl order-1 md:order-2 text-center md:text-left">
      ...
      <div className="flex justify-center md:justify-start flex-wrap gap-4 sm:gap-7 pt-4">
